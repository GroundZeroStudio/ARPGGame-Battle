...
namespace Knight.Core
{
    ...
    public enum ObservableRefreshType
    {
        RefreshToBegin,
        Refresh,
        RefreshToEnd,
    ...
    public interface IObservableEvent
    {
        ...
        ObservableRefreshType RefreshType { get; set; }
    ...
    public class ObservableList<T> : IList<T>, IList, IObservableEvent
    {
        ...
        public ObservableRefreshType RefreshType { get; set; }
        ...
        {
            return this.mInnerList.FindIndex(match);
        }
    }
}
